...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestraestudiante` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestraestudiante_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
  CONSTRAINT `fk_muestraestudiante_muestrapersona1`
    FOREIGN KEY (`muestrapersona_id` )
    REFERENCES `sapbd`.`muestrapersona` (`cedula` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestradocente` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestradocente_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestraegresado` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestraegresado_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestraempleador` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestraempleador_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestraadministrativo` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestraadministrativo_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestradirector` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestradirector_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`muestraagencia` (
  ...
  `muestrapersona_id` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_muestraagencia_muestrapersona1_idx` (`muestrapersona_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `sapbd`.`encabezado` (
  ...
  PRIMARY KEY (`id`) ,
  INDEX `fk_encabezado_persona1_idx` (`persona_id` ASC) ,
  ...
  CONSTRAINT `fk_encabezado_persona1`
    FOREIGN KEY (`persona_id` )
    REFERENCES `sapbd`.`persona` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
